...
export default function Home()  {
  ...
  return (
    <>
      ...
      <div
        ref={chatRef}
        className={`fixed top-0 right-0 w-3/4 md:w-1/3  h-full bg-white shadow-lg transform transition-transform duration-300 ease-in-out ${isChatOpen ? 'translate-x-0' : 'translate-x-full'}`}
      >
